                                ...
                                @if (Route::has('login'))
                                    @auth
                                        @if (Auth::user()->utype === 'ADM')
                                            <li class="menu-item menu-item-has-children parent">
                                                <a title="my acc" href="#">My account({{ Auth::user()->name }})<i
                                                        class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                <ul class="submenu curency">
                                                    <li class="menu-item">
                                                        <a title="dashboard"
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="slider" href="{{ route('admin.homeslider') }}">Mange
                                                            Home Slider</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="logout" href="{{ route('logout') }}"
                                                            onclick="event.preventDefault(); document.getElementById('admin-logout').submit();">LogOut</a>
                                                    </li>
                                                    <form id="admin-logout" method="POST"
                                                        action="{{ route('logout') }}">
                                                        @csrf
                                        ...
                                        @else
                                            <li class="menu-item menu-item-has-children parent">
                                                <a title="my acc" href="#">My
                                                    account({{ Auth::user()->name }})<i class="fa fa-angle-down"
                                                        aria-hidden="true"></i></a>
                                                <ul class="submenu curency">
                                                    <li class="menu-item">
                                                        <a title="dashboard"
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="logout" href="{{ route('logout') }}"
                                                            onclick="event.preventDefault(); document.getElementById('user-logout').submit();">LogOut</a>
                                                    </li>
                                                    <form id="user-logout" method="POST"
                                                        action="{{ route('logout') }}">
                                                        @csrf
