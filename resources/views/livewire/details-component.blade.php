                            ...
                            @foreach ($products as $releted_product)
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('product.details', ['slug' => $releted_product->slug]) }}"
                                            title="{{ $releted_product->name }}">
                                            <figure><img
                                                    src="{{ asset('assets/images/products/') }}/{{ $releted_product->image }}"
                                                    width="214" height="214"
                                                    alt="{{ $releted_product->name }}">
                                            </figure>
                                        </a>
                                    ...
                                    <div class="product-info">
                                        <a href="{{ route('product.details', ['slug' => $releted_product->slug]) }}"
                                            class="product-name"><span>{{ $releted_product->name }}</span></a>
                                        <div class="wrap-price"><span
                                                class="product-price">{{ $releted_product->regular_price }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
