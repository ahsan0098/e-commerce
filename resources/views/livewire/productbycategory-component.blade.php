        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <h1 class="shop-title">{{ Str::ucfirst($category_name) }}</h1>
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="use-chosen" wire:model="sorting">
                                ...
                                <option value="price_l2h">Sort by price: low to high</option>
                                <option value="price_h2l">Sort by price: high to low</option>
                            </select>
                        </div>

                        <div class="sort-item product-per-page" wire:model="size">
                            ...
                            <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                <div class="product product-style-3 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('category.details', ['slug' => $product->slug]) }}"
                                            title="{{ $product->name }}">
                                            <figure><img
                ...
                <div class="wrap-pagination-info">
                    ...
                    <p class="result-count">{{ $products->links() }}</p>
                </div>
            </div>
                    ...
                    <div class="widget-content">
                        <ul class="list-category">
                            @foreach ($categories as $category)
                                <li class="category-item has-child-cate my-2">
