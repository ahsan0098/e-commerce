        ...
        <div class=" main-content-area">
            ...
            <div class="wrap-iten-in-cart">
                ...
                @if (Cart::count() > 0)
                    ...
                    <h3 class="box-title">Products Name {{ $incerease }}</h3>
                                ...
                                <div class="quantity">
                                    <div class="quantity-input">
                                        ...
                                        <a class="btn btn-increase" href="#"
                                            wire:click.prevent="addQuntity('{{ $item->rowId }}')"></a>
                                        <a class="btn btn-reduce" href="#"
                                            wire:click.prevent="reduceQuntity('{{ $item->rowId }}')"></a>
                                    </div>
                                </div>
                                ...
                                <div class="delete">
                                    <a href="#" class="btn btn-delete" title="">
                                        ...
                                        <i class="fa fa-times-circle" aria-hidden="true"
                                            wire:click="deleteFromCart('{{ $item->rowId }}')"></i>
                                    </a>
                                </div>
                            </li>
                        @endforeach
            ...
            <div class="summary">
                ...
                <div class="checkout-info">
                    ...
                    <a class="btn btn-checkout" href="checkout.html"
                        wire:click.prevent="gotostripe({{ Cart::total() }})">Check out
                    </a>
